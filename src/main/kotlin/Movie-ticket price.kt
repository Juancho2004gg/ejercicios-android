...
fun ticketPrice(age: Int, isMonday: Boolean): Int {
    var childrenTicketPrice: Int = 15
    var standardTicketPrice: Int = 30
    var seniorTicketPrice: Int = 20
    var mondayDiscount: Int = 5  // 5 dollars

    if(age in 1..12){
        return childrenTicketPrice
    }
    else if(age in 13..60){
        return if (isMonday) standardTicketPrice - mondayDiscount else standardTicketPrice
